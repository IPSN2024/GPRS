...
## 2. Domain Adaptation Results

An intuitive comparison between GPRS and the prevalent model is shown as follows. For demonstration purposes, we provide different metrics for comprehensively evaluating results. 

### 2.1 Crossing Different Soils
...
### 2.2 Crossing Different Environments
